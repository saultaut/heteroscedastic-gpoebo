...
from acquisition.acquisition_functions import heteroscedastic_augmented_expected_improvement
...
class GPOEBO_HAEI:
    ...
    def optimize(self, X_data_init=None, Y_data_init=None):
        ...
        for iteration in range(self.no_iterations):
            ...
            X_next = heteroscedastic_augmented_expected_improvement(self.model, mu, var, X_test, self.weight_matrix, self.aleatoric_weight)
